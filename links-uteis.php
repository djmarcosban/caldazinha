            <div class="links">
              <a href="licitacoes" class="icon icon-gavel" target="_blank"><span>Licitação</span></a>
              <a href="contratos" class="icon icon-file-checked" target="_blank"><span>Contratos</span></a>
              <a href="concursos" class="icon icon-checklist" target="_blank"><span>Concursos</span></a>
              <a href="rreoscnt" class="icon icon-chart" target="_blank"><span>Relatórios</span></a>
